\begin{frame}{DADA's awkward history}
    \begin{itemize}
...
\begin{frame}{trying to add defense}
    \begin{itemize}
    \item I've tried to add more `defense' material
        \begin{itemize}
        \item memory-safety, testing, sandboxing
        \end{itemize}
    \item also useful for addressing non-memory-safety, non-injection vulns
        \begin{itemize}
        \item a lot less `systematic' material on such exploits
        \end{itemize}
    \end{itemize}
\end{frame}
