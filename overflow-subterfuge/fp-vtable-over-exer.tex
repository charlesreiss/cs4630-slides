...
\begin{tikzpicture}
    ...
    \draw[white,ultra thick] ([yshift=3.5mm,xshift=-1mm]vulnClass.south west) -- ++(2mm,0mm);
    \draw[white,ultra thick] ([yshift=3.5mm,xshift=-1mm]vulnClass.south east) -- ++(2mm,0mm);
