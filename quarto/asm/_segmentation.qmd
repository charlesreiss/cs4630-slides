...
::: {.r-stack}
![](texfig/segmentation.figure-1.svg){.fragment .fade-in-then-out fragment-index=1}

![](texfig/segmentation.figure-2.svg){.fragment .fade-in-then-out fragment-index=2}
...
::: {.r-stack}
![](texfig/x86SegPic.figure-1.svg){.fragment .fade-in-then-out fragment-index=1}

![](texfig/x86SegPic.figure-2.svg){.fragment .fade-in-then-out fragment-index=2}

![](texfig/x86SegPic.figure-3.svg){.fragment .fade-in-then-out fragment-index=3}
...
::: {.r-stack}
![](texfig/segmentation-x86-segment-descriptor.figure-1.svg){.fragment .fade-in-then-out fragment-index=1}

![](texfig/segmentation-x86-segment-descriptor.figure-2.svg){.fragment .fade-in-then-out fragment-index=2}

![](texfig/segmentation-x86-segment-descriptor.figure-3.svg){.fragment .fade-in-then-out fragment-index=3}
...
* … except for <code>%fs</code>, <code>%gs</code> 
