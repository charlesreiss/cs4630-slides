...
program header: <pre><code>LOAD off    0x0000000 vaddr 0x00400000 paddr 0x00400000 align 2**12
...
LOAD off    0x00bc0c0 vaddr 0x004bd0c0 paddr 0x004bd0c0 align 2**12
 ...
 <hr />
 actually loaded (via Linux <code>/proc/PID/maps</code>): <pre><code>memory address       size        r/w? file offset
~~~~~~~~~~~~~~~~~ (~~~~~~~~)     ~~~~ ~~~~~~~~ 
