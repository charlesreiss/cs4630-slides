...
* 4 seperately loaded segments, but cannot be indepenedntly randomized
...
<hr class="vspace" />
* simplifies application loading code
* allows same code to loaded in multiple processes
   *  but limits practical randomization
