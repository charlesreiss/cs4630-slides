...
```
class Foo { public: virtual const char *bar() { ... } };
...
Foo *f = new Foo;
...
* if leaked value was 0x822003 and in a debugger (with <em>different randomization</em>): 
   ...
   * a ‘‘gadget’’ address from the C shared library was 0x2aaaa40034
...
* can't use it to find things on heap, stack, in C shared library 
