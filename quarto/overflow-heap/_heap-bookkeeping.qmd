...
* two common strategies for tracking metadata: 
   * <em>before each allocation/beginning of free blocks</em> (example: GNU libc malloc [Linux default; Windows default?])
...
* [<em>arbitrary memory write</em>]{.fragment fragment-index=2}
