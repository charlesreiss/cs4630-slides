...
* can skip <code>\\textbackslash{} 0</code> if prefixed with backslash
...
* run sudo, triggering buffer overflow to change <br> <code>[]{.my-small} sudoers_hook_getenv("SYSTEMD_BYPASS_USERDB", ...)</code> <br> into <br> <code>[]{.my-small} execv(SYSTEMD_BYPASS_USERDB, ...)</code> 
