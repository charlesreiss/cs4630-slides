...
![](/overflow-smash/texfig/smash-set-ret.figure-1.svg){.fragment .fade-out fragment-index=2 fig-alt="The stack layout has the initial stack pointer with main's stuff on top, then usage by other functions, then the 'vulnerable' function return addr, then the 'vulnerable' function buffer, then other variables in the vulnerable function, then scanf's stuff"}
