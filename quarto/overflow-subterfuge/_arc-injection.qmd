...
![](/overflow-subterfuge/texfig/returnToSomewhere.figure-1.svg)

:::

![](/overflow-subterfuge/texfig/returnToSomewhere.figure-2.svg){.fragment .fade-in-then-out fragment-index=2}
...
* if address randomization disabled: <br> address should be `0x00002aaaaab650 + 0x55410`
<hr class="vspace" />
