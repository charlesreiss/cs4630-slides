...
<pre><code>    memmove((char *)<em>datapt</em>, dp, (unsigned)dlen);</code></pre>

![](/overflow-subterfuge/texfig/target.figure-1.svg){.nostretch width=1000px}

<ul style="position:relative; top: -100px">
<li class="fragment" data-fragment-index=1>  attacker controls amount copied into datapt = buffer
<li class="fragment" data-fragment-index=1>  overflow can overwrite datapt pointer...
<li class="fragment" data-fragment-index=2>  attacker triggers memmove again to use datapt to write elsewhere
</ul>
