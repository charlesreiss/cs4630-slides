...
\newsavebox{\subterExBC}
\newsavebox{\subterExBAsm}
\begin{document}
...
\setSlide{1}
\input{overflow-subterfuge/texfig/simple-subter-ex-exercise-2.inner.tex}
\end{document}
