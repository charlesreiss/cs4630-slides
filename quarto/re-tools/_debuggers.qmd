...
### selected debugger fetures (2)  {.smaller}
...
::: {.r-stack .my-full}
![](/re-tools/texfig/debuggers-ghidra-dynamic-view.figure-1.svg){.fragment .fade-in-then-out fragment-index=1}
