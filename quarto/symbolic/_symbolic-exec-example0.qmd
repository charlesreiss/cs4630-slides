...
* can express return value of function
...
![](/symbolic/texfig/choosePath0.figure-1.svg){.fragment .fade-in-then-out fragment-index=1 width=300px}

![](/symbolic/texfig/choosePath0.figure-2.svg){.fragment .fade-in-then-out fragment-index=2 width=300px}

![](/symbolic/texfig/choosePath0.figure-3.svg){.fragment .fade-in-then-out fragment-index=3 width=300px}

![](/symbolic/texfig/choosePath0.figure-4.svg){.fragment .fade-in-then-out fragment-index=4 width=300px}
