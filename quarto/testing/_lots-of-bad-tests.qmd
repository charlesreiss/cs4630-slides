...
*  is useful to test thing like `<html*<head` and `<head><iead>`, etc...
*  but probably not where we should spend a majority of our effort
   *  want more than "syntax error" handling bugs
<hr class="vspace" />
*  alternate idea: have a "grammar" of what the input should look like
