...
<hr class="vspace">
* modern compilers don't start functions so consistently...
* but probably similar patterns to look for
...
* easy solution: request to make it writable 
   * Linux: <code>mprotect</code>, Windows: <code>VirtualProtect</code>
   * functions commonly used by programs that compile code at runtime
     *  example: Java and JavaScript implementations
