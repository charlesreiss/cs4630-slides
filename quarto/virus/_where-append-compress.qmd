...
![](/virus/texfig/where-append-compress-appending.figure.svg){fig-alt="executable transformed by replacing some of the original code with jmp + appending virus"}
