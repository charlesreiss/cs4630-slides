...
![](/x8664-encoding/texfig/basics-16-bit-modrm-table.figure-1.svg){.fragment .fade-out fragment-index=1}

![](/x8664-encoding/texfig/basics-16-bit-modrm-table.figure-2.svg){.fragment .fade-in-then-out fragment-index=1}
...
![](/x8664-encoding/texfig/basics-32-bit-modrm-table.figure-1.svg){.fragment .fade-out fragment-index=1}

![](/x8664-encoding/texfig/basics-32-bit-modrm-table.figure-2.svg){.fragment .fade-in-then-out fragment-index=1}
...
![](/x8664-encoding/texfig/basics-basic-32-bit-encoding.figure.svg){style="width: 1000px"}

* dashed: not always present
* opcodes: 1-3 bytes 
   * [some 5-bit opcodes, with 3-bit register field]{.fragment fragment-index=1 .myem-only .custom}
       * (alternate view: 8-bit opcode with fixed register)
   * [sometimes Reg part of ModRM used as add'tl part of opcode]{.fragment fragment-index=2 .myem-only .custom}
