...
* `pushq %r13` encoded as <code>41 55</code>  
   ...
   * <code>41</code>: REX prefix <code>0010</code> (constant), w:<code>0</code>, r:<code>0</code>, s:<code>0</code>, b:<code><span style="color: blue">1</span></code>
   ...
   * 4-bit reg # <code><span style="color: blue">1</span><span style="color: darkgreen">101</span></code> = 13
...
* <code>5a</code>: SIB: scale = <code>01</code>, index = <code>011</code>, base = <code>010</code> 
   ...
   * with REX: index = <code><span style="color: blue">[1]{.fragment fragment-index=4 .custom .myem-only}</span>011</code> (11), base = <code><span style="color: darkgreen">[1]{.fragment fragment-index=5 .custom .myem-only}</span>010</code> (10)
...
* <code>2c</code>: ModRM: mod = <code>00</code>, reg = <code>101</code>, r/m: <code>100</code> 
   ...
   * with REX: reg = <code><em><span style="color: darkviolet">[1]{.fragment fragment-index=2 .custom .myem-only}</span></em>101</code> [%r13]; r/m = 100 (SIB follows)

* <code>25</code>: SIB: scale = <code>00</code>; index = <code>(<span style="color: blue">[0]{.fragment fragment-index=3 .custom .myem-only}</span>)100</code>; base = <code>(<span style="color: darkgreen">[0]{.fragment fragment-index=4 .custom .myem-only}</span>)101</code> 
